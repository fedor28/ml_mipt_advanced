...
class Encoder(nn.Module):
    def __init__(self, input_dim, emb_dim, hid_dim, n_layers, dropout, filter_dim, activation):
        super().__init__()
...
#         self.dropout = dropout
        ...
        self.embedding = nn.Embedding(
            ...
            # <YOUR CODE HERE>
        self.cnn = nn.Conv1d(in_channels = emb_dim, out_channels= hid_dim, kernel_size = filter_dim)
            # <YOUR CODE HERE>
